module.exports = {
  repository: 'https://github.com/pizaranha/volt',
  bugs: 'https://github.com/pizaranha/volt/issues/new',

  meta: [
    { internal: true, to: '/about', label: 'About' },
    {
      href: 'https://github.com/pizaranha/volt/issues/new',
      label: 'Report issue',
    },
    {
      href: 'https://github.com/pizaranha/volt/blob/master/CONTRIBUTING.md',
      label: 'Contribute',
    },
    {
      href: 'https://github.com/pizaranha/volt/blob/master/CHANGELOG.md',
      label: 'Changelog',
    },
  ],
